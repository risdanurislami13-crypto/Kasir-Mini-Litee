...
import com.example.kasirmini.activities.AddPenjualanActivity;
import com.example.kasirmini.adapters.PenjualanAdapter;
...
public class PenjualanFragment extends Fragment {
    ...
    private void initViews(View view) {
        ...
        fabAdd.setOnClickListener(v -> {
            Intent intent = new Intent(getActivity(), AddPenjualanActivity.class);
    ...
    private void setupRecyclerView() {
        ...
        adapter = new PenjualanAdapter(getContext(), penjualanList);
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot data : snapshot.getChildren()) {
                    Penjualan penjualan = data.getValue(Penjualan.class);
                    if (penjualan != null) {
                        penjualanList.add(penjualan);
                    }
                }
                Collections.reverse(penjualanList);
